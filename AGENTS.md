...
- Liepin interaction pacing defaults to randomized `2000-3000ms` waits for in-page actions, successful resume-detail closing, and candidate-to-candidate transitions. Click helpers should move the mouse to the target before clicking when possible.
