...
> Status: historical design baseline captured on 2026-06-10. Current routes, behavior, and safety contracts are owned by `frontend/`, its tests, and `frontend/AGENTS.md`.
