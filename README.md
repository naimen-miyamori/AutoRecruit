...
Boss 的 direct 搜索会先通过页面“清空筛选”回到基线，再逐项应用并复核本次筛选，避免复用页面继承人工或上轮条件。当前 application-filter 输入支持目录内的单选、年龄/薪资范围、院校要求多选、学历/经验自定义范围、城市、职位范围、公司文本、专业，以及“过滤近 14 天查看”“近 30 天未和同事交换简历”两个独立布尔条件；多选会校验最终集合而非只确认一次点击。当前实页“更多筛选”以“专业”为最后一项，没有“资格证书”，Boss 不注册或导出虚构字段。非基线进入状态尚未全部进入可恢复合同，不能据此宣称全覆盖。
